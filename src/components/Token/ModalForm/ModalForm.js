...
const Overlay = ({ show, close }) => {
      ...
      case 0:
        return (
          <Fragment>
            ...
            <input
              type="text"
              placeholder={t("common:contract_address")}
              className={lang === "ar" ? styles.inputField_rtl : styles.input_Field_ltr}
            />
            ...
            <input
              type="checkbox"
              className={lang === "ar" ? styles.checkBox_rtl : styles.checkBox_ltr}
              id="agreement"
              name="agreement"
              value="agreement"
            />
            <label htmlFor="agreement" className={lang === "ar" ? styles.agree_rtl : styles.agree_ltr}>
              {" "}
              {t("common:check")} <a href="#">{t("common:terms_conditions")}</a>{" "}
            </label>
          </Fragment>
        );
      case 1:
        return (
          <Fragment>
            ...
            <div className={styles.upload}>
              ...
              <button className={styles.uploadBtn} onClick={() => uploading}>
      ...
      case 2:
        return (
          <Fragment>
            ...
            <textarea
              className={lang === "ar" ? styles.comment_rtl : styles.comment_ltr}
              placeholder={t("common:token_bio")}
            ></textarea>
          ...
          <Fragment>
            ...
            <div className="input-group mb-3">
              <div className="input-group-prepend">
                <h6 className={` input-group-text ${styles.socialIcon} ${styles.fbIcon}`} id="basic-addon1">
                  <FaFacebookF />
                </h6>
              </div>
              <input
                type="text"
                className={`form-control ${styles.socialInput} ${styles.fb}`}
            ...
            <div className="input-group mb-3">
              <div className="input-group-prepend">
                <h6 className={` input-group-text ${styles.socialIcon} ${styles.youIcon}`} id="basic-addon1">
                  <BsYoutube />
                </h6>
              </div>
              <input
                type="text"
                className={`form-control ${styles.socialInput} ${styles.you}`}
                placeholder={t("common:youtube")}
                aria-label="Username"
                aria-describedby="basic-addon1"
              />
            </div>
            ...
            <div className="input-group mb-3">
              <div className="input-group-prepend">
                <h6 className={` input-group-text ${styles.socialIcon} ${styles.tweetIcon}`} id="basic-addon1">
                  <BsTwitter />
                </h6>
              </div>
              <input
                type="text"
                className={`form-control ${styles.socialInput} ${styles.tweet}`}
            ...
            <div className="input-group mb-3">
              <div className="input-group-prepend">
                <h6 className={` input-group-text ${styles.socialIcon} ${styles.teleIcon}`} id="basic-addon1">
                  <FaTelegramPlane />
                </h6>
              </div>
              <input
                type="text"
                className={`form-control ${styles.socialInput} ${styles.tele}`}
                placeholder={t("common:telegram")}
                aria-label="Username"
                aria-describedby="basic-addon1"
              />
            </div>
  ...
  return (
    <div className={`${styles.overlay} ${show ? styles.show2 : null}`}>
      <button className={lang === "ar" ? styles.closeBtn_rtl : styles.closeBtn_ltr} onClick={() => close()}>
        {t("common:close")}
      </button>
          ...
          <React.Fragment>
            <Typography sx={{ mt: 2, mb: 1, display: "block !important" }}>
              <div className={styles.check}>
                ...
                <button className={styles.return} onClick={() => close()}>
                  {t("common:return")}
                </button>
              </div>
            </Typography>
