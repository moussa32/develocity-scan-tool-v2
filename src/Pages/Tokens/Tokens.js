...
const Tokens = () => {
  ...
  <ul className={`dropdown-menu `}>
    ...
    <li role="button" className="d-flex justify-content-between"><button className="dropdown-item fs-5" value='tr' onClick={handleChange}>Store of Value</button></li>
                  ...
                  <button
                    className={` ${isVerified ? styles.verified_btn : styles.notverified_btn} ${
                      value[3] ? styles.disabled_verified_btn : ""
                    }`}
                    onClick={handleClick}
                    disabled={value[3]}
                  >
          ...
          <div className="row">
            {tokenList_loading === "success" ? (
              <div className="col-12">
                {tokenList && <TokensTable tokenList={tokenList ? tokenList : null} isVerifyied={isVerified} />}
              </div>
            ) : null}
            {tokenList_loading === true ? (
              <div className="col-12">
                <TableLoader />
              </div>
            ) : null}
