    ...
    <section className="container pb-[80.7px] border-b-[0.5px] border-[#4f4b4b]">
      <section className="grid grid-cols-1 md:grid-cols-2">
        <div>
          ...
          <h1 className="font-bold text-5xl lg:text-[56px] text-white font-inter max-w-[446px] mb-[34px]">
            Master the art of crypto trading
          </h1>
          <p className="text-xl lg:text-[32px] font-inter text-secondaryText">
            Trade smarter,not harder with our crypto scanner tool.
          </p>
          <p className="text-xl text-[32px] font-inter text-secondaryText">
            Get real-time insights and maximize your profits effortlessly
          </p>
          <a href="https://develocity.finance">
            <button className="bg-primary text-white py-3.5 px-8 lg:h-[60px] text-sm lg:text-[22px] mt-8 lg:mt-[97.1px]">
              Visit Develocity
            </button>
          </a>
        </div>
