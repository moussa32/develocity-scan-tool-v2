      ...
      <div className={`${colsWidth.token} w-full lg:w-1/2 flex gap-5`}>
        {image ? (
          <img
            ...
            className="w-10 h-10 lg:w-14 lg:h-14 flex-[0_1_36px] lg:flex-[0_1_45px]"
            src={image}
            alt={name}
            title={name}
          />
        ) : (
          <h3 className=w-10 h-10 lg:w-14 lg:h-14 flex-[0_1_36px] lg:flex-[0_1_45px] lg:w-11 lg:h-11 flex flex-shrink-0 items-center rounded-full justify-center bg-primary/50">
