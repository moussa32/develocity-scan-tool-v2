    ...
    <div className="bg-[#272B40] xl:px-[42px] rounded-lg p-6 lg:py-8 flex justify-between flex-wrap lg:flex-nowrap items-center">
      <div className="flex text-white flex-shrink-1 grow-0">
        ...
        <div className="flex flex-col items-start justify-center gap-[2px]">
          <h2 className="font-bold font-segoe text-xl lg:text-2xl">{name}</h2>
          <span className="flex-initial font-segoe text-xl lg:text-2xl">
            {symbol}
          </span>
        </div>
      </div>
      <div className="flex mt-6 lg:mt-0 flex-row-reverse justify-between lg:flex-col gap-3 order-3 lg:order-2 items-center w-full">
        <span className="font-segoe text-white text-xl lg:text-2xl">
