    ...
    <>
      <section className="flex items-center justify-center lg:justify-start lg:ltr:ml-[35px] lg:rtl:mr-[35px] gap-[10px] w-full">
        <Button
          ...
          className="border-1 border-primary bg-transparent h-[42px] max-w-[160px] flex font-medium text-sm items-center w-full transition-all duration-200 ease-in-out justify-center text-primary hover:text-semiWhite hover:bg-primary"
        >
          Log In
        </Button>
        <Button
      ...
      <CreateAccountModal isOpen={isCreateAccountOpen} closeModal={closeModal} />
    </>
  );
};
